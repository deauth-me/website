...
const architectureData = [
  ...
  // Additions: Romanesque Churches
  {
    id: "speyer-cathedral",
    name: "Speyer Cathedral",
    type: "Cathedral",
    location: "Speyer, Germany",
    imageUrl: "/images/speyer-cathedral.jpg",
    period: "Romanesque",
    description: "One of the largest and most significant Romanesque cathedrals in Europe, a UNESCO World Heritage Site, known for its imposing scale and imperial crypt.",
    yearBuilt: "c. 1030-1106",
    architecturalStyle: "Romanesque",
    features: ["Twin towers", "Massive crypt", "Groin vaults", "Imperial burial site"],
  },
  {
    id: "durham-cathedral",
    ...
    imageUrl: "/images/durham-cathedral.jpg",
    period: "Romanesque",
    description: "A prime example of Norman (English Romanesque) architecture, famed for being the earliest large-scale building with stone rib vaults, a precursor to Gothic style. UNESCO site.",
    yearBuilt: "1093-1133",
    architecturalStyle: "Norman (Romanesque)",
    features: ["Pioneering rib vaults", "Massive piers", "Shrine of St Cuthbert", "Intact Norman architecture"],
  },
  {
    id: "autun-cathedral",
    name: "Autun Cathedral (Saint Lazare)",
    type: "Cathedral",
    location: "Autun, France",
    imageUrl: "/images/autun-cathedral.jpg",
    period: "Romanesque",
    description: "A highlight of Burgundian Romanesque art, famous for the intricate and expressive sculptures by Gislebertus, especially the Last Judgment tympanum.",
    yearBuilt: "1120-1146 (Gothic additions later)",
    architecturalStyle: "Burgundian Romanesque, Gothic additions",
    features: ["Gislebertus sculptures", "Last Judgment tympanum", "Cluniac influence", "Relics of Lazarus"],
  },
  {
    id: "saint-sernin-basilica",
    name: "Basilica of Saint Sernin",
    type: "Basilica",
    location: "Toulouse, France",
    imageUrl: "/images/saint-sernin-basilica.jpg",
    period: "Romanesque",
    description: "One of the largest and best-preserved Romanesque churches in Europe, a major stop on the Santiago de Compostela pilgrimage route. UNESCO site.",
    yearBuilt: "c. 1080-1120",
    architecturalStyle: "Romanesque",
    features: ["Five-aisled nave", "Octagonal bell tower", "Barrel vault", "Pilgrimage church"],
  },
   {
    id: "pisa-cathedral",
    ...
    type: "Cathedral",
    location: "Pisa, Italy",
    imageUrl: "/images/pisa-cathedral.jpg",
    period: "Romanesque",
    description: "The centerpiece of the Piazza dei Miracoli (Square of Miracles), a masterpiece of Pisan Romanesque architecture known for its separate campanile (Leaning Tower). UNESCO site.",
    yearBuilt: "1063-1092 (additions later)",
    architecturalStyle: "Pisan Romanesque",
    features: ["Leaning Tower (Campanile)", "Bronze doors", "Polychrome marble facade", "Pulpit by Giovanni Pisano"],
  },
  // Additions: Gothic Churches
  {
    id: "saint-denis-basilica",
    name: "Basilica Cathedral of Saint-Denis",
    type: "Basilica / Cathedral",
    location: "Saint-Denis, Paris, France",
    imageUrl: "/images/saint-denis-basilica.jpg",
    period: "Gothic",
    description: "Considered the birthplace of Gothic architecture, pioneering features like the ribbed vault and extensive use of stained glass under Abbot Suger. Royal necropolis for French monarchs.",
    yearBuilt: "1135-1144 (choir), later additions",
    architecturalStyle: "Early Gothic",
    features: ["First use of Gothic elements", "Royal tombs", "Rose windows", "Ribbed vaults"],
  },
  {
    id: "saint-vitus-cathedral",
    name: "St. Vitus Cathedral",
    type: "Cathedral",
    location: "Prague, Czech Republic",
    imageUrl: "/images/saint-vitus-cathedral.jpg",
    period: "Gothic",
    description: "An outstanding example of Gothic architecture located within Prague Castle, housing the Czech Crown Jewels and tombs of Bohemian kings and Holy Roman Emperors. Construction spanned almost 600 years.",
    yearBuilt: "1344-1929",
    architecturalStyle: "Gothic, Neo-Gothic elements",
    features: ["St. Wenceslas Chapel", "Czech Crown Jewels", "Rose window", "Gargoyles"],
  },
  {
    id: "milan-cathedral",
    ...
    imageUrl: "/images/milan-cathedral.jpg",
    period: "Gothic",
    description: "The largest church in Italy and one of the largest in the world, a spectacular example of late Gothic architecture that took nearly six centuries to complete, known for its forest of spires.",
    yearBuilt: "1386-1965",
    architecturalStyle: "Late Gothic, Renaissance and Neoclassical elements",
    features: ["135 spires", "Madonnina statue", "Vast scale", "Stained glass windows"],
  },
  {
    id: "reims-cathedral",
    name: "Reims Cathedral (Notre-Dame de Reims)",
    type: "Cathedral",
    location: "Reims, France",
    imageUrl: "/images/reims-cathedral.jpg",
    period: "Gothic",
    description: "A masterpiece of High Gothic architecture, the traditional coronation site for the kings of France. Renowned for its sculptural program and architectural unity. UNESCO site.",
    yearBuilt: "1211-1345",
    architecturalStyle: "High Gothic",
    features: ["Coronation site", "Smiling Angel sculpture", "Rich sculptural decoration", "Rose windows"],
  },
  {
    ...
    imageUrl: "/images/salisbury-cathedral.jpg",
    period: "Gothic",
    description: "An exceptional example of Early English Gothic architecture, largely built in just 38 years. Features the tallest church spire in the UK and preserves one of the best original copies of the Magna Carta.",
    yearBuilt: "1220-1258 (spire later)",
    architecturalStyle: "Early English Gothic",
    features: ["Tallest spire in UK", "Best-preserved Magna Carta", "Large cloister", "Oldest working clock (c.1386)"],
  },
  // Additions: Modernist Churches (Brazil)
  {
    id: "cathedral-of-brasilia",
    name: "Cathedral of Brasília (Metropolitan Cathedral of Our Lady Aparecida)",
    type: "Cathedral",
    location: "Brasília, Brazil",
    imageUrl: "/images/cathedral-of-brasilia.jpg",
    period: "Modern",
    description: "Iconic modernist structure designed by Oscar Niemeyer, featuring 16 concrete columns forming a hyperboloid shape, appearing open to the sky. Most of the structure is below ground.",
    yearBuilt: "1958-1970",
    architecturalStyle: "Brazilian Modernism",
    features: ["Hyperboloid structure", "Glass roof", "Suspended angel sculptures", "Bronze Evangelist statues"],
  },
  {
    id: "church-saint-francis-assisi-pampulha",
    name: "Church of Saint Francis of Assisi (Igreja de São Francisco de Assis)",
    type: "Church",
    location: "Pampulha, Belo Horizonte, Brazil",
    imageUrl: "/images/church-saint-francis-assisi-pampulha.jpg",
    period: "Modern",
    description: "Early masterpiece by Oscar Niemeyer, part of the Pampulha Modern Ensemble (UNESCO). Known for its bold parabolic concrete vaults and azulejo tile murals by Cândido Portinari.",
    yearBuilt: "1940-1943",
    architecturalStyle: "Brazilian Modernism",
    features: ["Parabolic concrete vaults", "Portinari tile murals", "Curved forms", "Part of Pampulha Modern Ensemble"],
  },
  {
    id: "rio-de-janeiro-cathedral",
    name: "Metropolitan Cathedral of Saint Sebastian (Rio de Janeiro Cathedral)",
    type: "Cathedral",
    location: "Rio de Janeiro, Brazil",
    imageUrl: "/images/rio-de-janeiro-cathedral.jpg",
    period: "Modern",
    description: "A striking modernist cathedral designed by Edgar Fonceca, shaped like a truncated cone inspired by Mayan pyramids. Features four monumental stained-glass windows reaching from floor to ceiling.",
    yearBuilt: "1964-1979",
    architecturalStyle: "Brazilian Modernism",
    features: ["Conical shape", "Monumental stained glass windows", "Brutalist elements", "Capacity for 20,000 people"],
  },
  {
    id: "cathedral-of-maringa",
    name: "Cathedral of Maringá (Catedral Basílica Menor Nossa Senhora da Glória)",
    type: "Cathedral",
    location: "Maringá, Brazil",
    imageUrl: "/images/cathedral-of-maringa.jpg",
    period: "Modern",
    description: "A tall, modernist conical Roman Catholic cathedral inspired by Soviet Sputnik satellites, designed by José Augusto Bellucci. It is the tallest church in South America.",
    yearBuilt: "1959-1972",
    architecturalStyle: "Modernist",
    features: ["Conical design", "Tallest church in South America", "Inspired by Sputnik", "Foundation stone from St. Peter's Basilica"],
  },
  {
    id: "santuario-dom-bosco",
    name: "Santuário Dom Bosco (Sanctuary of Dom Bosco)",
    type: "Sanctuary / Church",
    location: "Brasília, Brazil",
    imageUrl: "/images/santuario-dom-bosco.jpg",
    period: "Modern",
    description: "Designed by Carlos Alberto Naves, this church is renowned for its breathtaking interior created by 80 concrete columns supporting 12 shades of blue stained glass, evoking a starry sky. Dedicated to the patron saint of Brasília.",
    yearBuilt: "1963-1970",
    architecturalStyle: "Brazilian Modernism",
    features: ["Blue stained glass interior", "80 supporting columns", "Large central chandelier", "Dedicated to Brasília's patron saint"],
  }
];
